"""Prognozy "z zewnątrz" (out-of-fold) trzech modeli w foldach walidacji kroczącej na treningu.

W każdym foldzie model uczy się tylko na danych sprzed okna testowego, więc jego prognoza na to okno
jest uczciwa. Na tych prognozach dobieramy wagi ensemble. Zbiór egzaminacyjny nie bierze w tym udziału.
"""
import warnings
